...
const STEPS = [
  {
    ...
    title: 'Situation',
    body:
      'The team needed an esports identity that felt as intense as their gameplay — something spectators and sponsors would recognize instantly, beyond a generic gaming look.',
  },
  {
    num: '02',
    title: 'Action',
    body:
      'I developed the hippo mark and wordmark system, explored jersey geometry and placement, and produced digital mockups and presentation boards to align stakeholders on direction.',
  },
  {
    num: '03',
    title: 'Result',
    body:
      'The final identity and jersey system gave Insta Kill a polished competitive presence — stronger recognition at events and a cohesive kit for players and sponsors.',
  },
] as const;
...
type InstaKillDesignJourneyProps = {
  scrollContainerRef: RefObject<HTMLElement | null>;
};

export function InstaKillDesignJourney({ scrollContainerRef }: InstaKillDesignJourneyProps) {
