...
import { PhotoshopLogo } from './ToolLogos';
...
function ToolsCardReveal({
  ...
  const maxWidth = useTransform(scrollYProgress, [start, end], [0, 280], { clamp: true });
...
function ProjectDataHeadline({
  ...
  const line1Opacity = useTransform(scrollYProgress, [t0, t0 + 0.08], [0, 1], { clamp: true });
  const line1X = useTransform(scrollYProgress, [t0, t0 + 0.12], [-24, 0], { clamp: true });
  ...
  const line2X = useTransform(scrollYProgress, [t0 + 0.06, t0 + 0.18], [20, 0], {
    clamp: true,
  });
  return (
...
export type InstaKillProjectDataProps = {
  scrollYProgress: MotionValue<number>;
};

export const InstaKillProjectData = forwardRef<HTMLElement, InstaKillProjectDataProps>(
  function InstaKillProjectData({ scrollYProgress }, ref) {
    return (
      <section
        ref={ref}
      ...
      >
        <div className="mx-auto flex max-w-7xl flex-col gap-12 md:flex-row md:gap-24">
          ...
          <div className="flex-1 space-y-16 pt-8">
            <ScrollRevealSection scrollYProgress={scrollYProgress} range={TITLE_REVEAL}>
            ...
            <div className="flex flex-col gap-20 md:gap-28 lg:ml-auto lg:max-w-3xl">
              ...
              >
                ...
                <p className="mt-4 max-w-md font-serif text-sm leading-relaxed text-white/70">
                  Transforming gameplay intensity into a recognizable visual identity.
                </p>
              </ScrollRevealSection>
              <ScrollRevealSection
                scrollYProgress={scrollYProgress}
...
InstaKillProjectData.displayName = 'InstaKillProjectData';
