      ...
      >
        ...
        >
          ...
          >
            ...
            >
              From Gameplay Intensity to Visual Identity — Branding{' '}
            </motion.span>
            <motion.span
              className="inline-block font-serif font-bold tracking-wide text-white"
      ...
      <div className="relative z-10 flex flex-1 flex-col pb-16">
        <div className="mt-auto flex items-end justify-between gap-6">
          ...
          <div className="text-right">
            <motion.h2
              className="font-serif text-[clamp(2.25rem,10vw,6.5rem)] font-black leading-none tracking-[0.06em] text-white md:tracking-[0.1em]"
              initial={reduce ? false : { opacity: 0, y: 28 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.85, delay: 0.35, ease: easeOut }}
            >
              <span className="whitespace-nowrap">INSTA KILL</span>
            </motion.h2>
          </div>
        </div>
      </div>
