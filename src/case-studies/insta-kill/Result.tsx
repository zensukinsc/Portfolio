...
export type InstaKillResultProps = {
  scrollContainerRef: RefObject<HTMLElement | null>;
};

export function InstaKillResult({ scrollContainerRef }: InstaKillResultProps) {
      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex items-stretch gap-0">
          ...
          <ResultCardReveal scrollYProgress={scrollYProgress}>
            ...
            >
              Delivered a professional esports visual identity and jersey system that
              elevated team recognition and competitive presence.
            </motion.p>
          </ResultCardReveal>
        </div>
      </div>
