...
const GALLERY_SLIDES: {
  ...
  {
    src: '/case-studies/namas/gallery/slide-01-home.png',
    alt: 'NAMAS Design & Build website — homepage with Zhemgang Dzong feature',
    label: 'Home',
  },
  {
    src: '/case-studies/namas/gallery/slide-02-project.png',
    alt: 'NAMAS website — Zhemgang Dzong project page with image carousel',
    label: 'Project',
  },
  {
    src: '/case-studies/namas/gallery/slide-03-gallery.png',
    alt: 'NAMAS website — project gallery interior visualization',
    label: 'Gallery',
  },
  {
    src: '/case-studies/namas/gallery/slide-04-featured.png',
    alt: 'NAMAS website — last projects section with Zhemgang Dzong',
    label: 'Featured',
  },
  {
    src: '/case-studies/namas/gallery/slide-05-testimonials.png',
    alt: 'NAMAS website — testimonials section',
    label: 'Reviews',
  },
];

export type NamasGalleryProps = {
  scrollContainerRef: RefObject<HTMLElement | null>;
};

export function NamasGallery({ scrollContainerRef }: NamasGalleryProps) {
