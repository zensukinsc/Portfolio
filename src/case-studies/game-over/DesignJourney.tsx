...
const STEPS = [
  {
    ...
    title: 'Situation',
    body:
      'Growing concerns about excessive gaming among Bhutanese youth revealed limited public understanding of its academic, psychological and social effects.',
  },
  {
    num: '02',
    title: 'Action',
    body:
      'Developed the documentary script focusing on real experiences and expert insights. Planned visual storytelling approaches, filmed interviews and gaming environments, and composed cinematic shots to reinforce the narrative. Edited footage to strengthen emotional impact, clarity and storytelling rhythm.',
  },
  {
    num: '03',
    title: 'Result',
    body:
      'Delivered a compelling documentary that communicated the realities of gaming addiction, promoted awareness, and demonstrated the power of visual storytelling in addressing youth-related social issues.',
  },
] as const;
...
type GameOverDesignJourneyProps = {
  scrollContainerRef: RefObject<HTMLElement | null>;
};

export function GameOverDesignJourney({ scrollContainerRef }: GameOverDesignJourneyProps) {
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-[100vh] max-h-[100vh] min-h-[100vh] flex-col overflow-hidden overflow-y-hidden border-t border-white/10 bg-black pt-24 md:pt-28">
        <motion.div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_30%_20%,rgba(255,255,255,0.1),transparent_55%)]"
